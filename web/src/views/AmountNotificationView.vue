<template>
  <div class="notification-view">
    ...
    <div v-if="notifications.length === 0" class="empty">暂无金额/支付相关通知</div>
...
async function fetch() {
  const res = await axios.get('/notifications', { params: { category: 'amount' } })
...
.noti-card.unread { background: #fff8f0; border-left: 4px solid #f39c12; }
